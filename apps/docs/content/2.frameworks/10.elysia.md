---
title: Elysia
description: Using evlog with Elysia — automatic wide events, structured errors, drain adapters, enrichers, and tail sampling in Elysia applications.
navigation:
  title: Elysia
...
Use `useLogger()` to access the request-scoped logger from anywhere in the call stack — no need to pass the context through your service layer:
