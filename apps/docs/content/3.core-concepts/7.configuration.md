---
title: Configuration
description: Complete reference for all evlog configuration options — global logger settings, middleware options, environment context, and framework-specific overrides.
navigation:
